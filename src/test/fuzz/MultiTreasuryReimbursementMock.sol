...
contract MultiIncreasingTreasuryReimbursementMock is GebMath {
    // --- Auth ---
    ...
    constructor(
      ...
      uint256 perSecondCallerRewardIncrease_
        ...
        if (address(treasury_) != address(0)) {
          require(StabilityFeeTreasuryLike(treasury_).systemCoin(coinName_) != address(0), "MultiIncreasingTreasuryReimbursement/treasury-coin-not-set");
        }
    ...
    **/
    function rewardCaller(address proposedFeeReceiver, uint256 reward) internal {
        ...
        try treasury.pullFunds(coinName, finalFeeReceiver, treasury.systemCoin(coinName), reward) {}
